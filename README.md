...
This is exam aims to measure a candidate's level of understanding PHP OOP concepts. It is divided into 3 levels and each level has their pre-requisites.

**Assessment Point System**: The assessment total is 125 points with additional 32 bonus points.
Passing grade is 75. See breakdown below for more detail.
...
**Asessment Duration**: Candidate is will be given 3 days (24 working hours) to complete the assessment. On a separate spreadsheet, please log the time spent per functionality (start time and end time).
For any questions regarding the assessment please send inquiry to <a href="mailto:ralph@playgroundzero.io">ralph@playgroundzero.io</a> or HR.

**Output**: Candidate is required to submit a Github Repository link which contains the assessment output files.
...
1. Start a project in Laravel 8 or later
